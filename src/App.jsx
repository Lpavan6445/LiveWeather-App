...
function App() {
   ...
   const search=(enter)=>{ 
      ...
      axios.get(`https://api.openweathermap.org/data/2.5/forecast?q=${enter}&appid=d9cf80cf524baa91b660512aa37ee574&units=metric&cnt=7`)
      .then((res)=>setState({...state, data:res.data, city:res.data.city.name}))
   }
                    ...
                    <div className="btncontainer">
                          <div className="col-md-8">
                              <div className="search"> 
                                ...
                                <button id="search"  onClick={()=>search(state.input)} className="btn btn-primary">Search</button>
                              </div>
                          </div>
                    </div>
